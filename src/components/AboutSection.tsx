        ...
        >
          <div className="space-y-6">
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              With [X] years of experience in the industry, I've worked on a
              wide range of projects from small business websites to large-scale
              enterprise applications.
            </p>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              My journey in tech started with [background/education], and I've
              since developed expertise in modern web technologies and best
              practices. I'm particularly interested in [specific areas of
              interest/expertise].
            </p>
